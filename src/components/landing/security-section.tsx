            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-black/50">Your message is encrypted before it leaves your device.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 rounded-full bg-black mt-2 flex-shrink-0" />
                <div>
                  ...
                  <p className="text-sm text-black/50">We can&apos;t read your messages. Ever.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 rounded-full bg-black mt-2 flex-shrink-0" />
                <div>
                  ...
                  <p className="text-sm text-black/50">Messages delete after one read or when TTL expires.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="glass rounded-3xl p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs tracking-wider text-black/40">Active</span>
                </div>
              </div>

              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-black/5">
                  <span className="font-mono text-xs tracking-wider text-black/40">Algorithm</span>
                  <span className="font-ui font-semibold text-sm">AES-256-CBC</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-black/5">
                  <span className="font-mono text-xs tracking-wider text-black/40">Key Length</span>
                  <span className="font-ui font-semibold text-sm">256-bit</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-black/5">
                  <span className="font-mono text-xs tracking-wider text-black/40">Storage</span>
                  <span className="font-ui font-semibold text-sm">Encrypted</span>
                </div>
                <div className="flex items-center justify-between py-3">
                  <span className="font-mono text-xs tracking-wider text-black/40">Logs</span>
